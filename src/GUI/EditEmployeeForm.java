...
public class EditEmployeeForm extends javax.swing.JFrame {
    ...
    /**
     * Method: preSelectPayLevel
     * Purpose:
     * Selects the pay level combo box item matching the employee's current pay level.
     * If none match, sets combo box to "Select Annual Salary".
     * 
     * Effect:
     * Updates the pay level combo box selection.
     */
