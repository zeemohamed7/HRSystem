 ...
 * edit an existing Department's details including its name, location, and
 * department head. It retrieves current data, validates user input, updates the
 * department and employee data accordingly, and refreshes the main window
 * display.
 */
public class EditDepartmentForm extends javax.swing.JFrame {
     ...
     *
     * Name: EditDepartmentForm Purpose: Default constructor required by the
     * JFrame. Input: None. Output: None. Effect: Creates an empty form.
     */
     ...
     *
     * Name: EditDepartmentForm Purpose: Initializes the form fields and
     * components with the selected department's details. Input: - main: The
     * MainWindow instance to allow UI updates. - dept: The Department object to
     * be edited. Output: None. Effect: Displays the form centered on screen
     * with fields populated with department info.
     *
...
//        initDepartmentHeadSelect(dept);
    ...
    private void initComponents() {
        ...
        editDepartmentSaveButton.setBackground(new java.awt.Color(0, 51, 102));
...
//}
     ...
     *
     * Name: departmentNameFieldActionPerformed Purpose: Placeholder for actions
     * when department name input is changed. Input: evt - the ActionEvent
     * triggered Output: None. Effect: Currently no additional behavior.
     *
     ...
     *
     * @author Mariam Name: locationFieldActionPerformed Purpose: Placeholder
     * for actions when location input is changed. Input: evt - the ActionEvent
     * triggered Output: None. Effect: Currently no additional behavior.
     *
     * @param evt ActionEvent generated by the text field
     */
     ...
     *
     * @author Zahraa Name: cancelButton2ActionPerformed Purpose: Closes the
     * edit form without saving changes. Input: evt - the ActionEvent triggered
     * by Cancel button Output: None. Effect: Closes and disposes the form
     * window.
     *
    ...
    /**
     * Handles action when the Save Changes button is clicked. Validates input,
     * updates department details, updates head employee's status, and refreshes
     * the UI.
     *
     * @author zainab Name: editDepartmentSaveButtonActionPerformed Purpose:
     * Saves the updated department data and reflects changes in the main
     * window. Input: evt - the ActionEvent triggered by Save Changes button
     * Output: None. Effect: Updates department and employee data, shows success
     * or error messages, and closes the form.
     *
     ...
     *
     * @author zainab Name: departmentHeadSelectActionPerformed Purpose:
     * Placeholder for actions when department head selection changes. Input:
     * evt - the ActionEvent triggered Output: None. Effect: Currently no
     * additional behavior.
     *
