 ...
 * @author zainab
 * @version 1.0
 * Purpose: Represents an employee with personal details, employment information,
 *          and association to a department. It includes logic for assigning unique
 *          employee IDs and tracking department head status.
 */
public class Employee implements Serializable {
    private static int staticEmployeeId = 1; // Used to auto-increment employee IDs
     ...
     * Effect: Creates an empty employee object
     */
    public Employee() {
    }
    /**
     * Name: Employee
     * Purpose: Constructor to create an employee without assigning a department
     ...
     * Effect: Initializes an employee object and auto-generates a unique ID
     */
    ...
    /**
     * Name: Employee
     * Purpose: Constructor to create an employee and assign them to a department
     * @param firstName - employee's first name
     * @param surname - employee's last name
     * @param gender - 'M' or 'F' representing the employee's gender
     * @param address - employee's address
     * @param payLevel - salary level of the employee
     * @param deptID - department ID the employee belongs to
     * Effect: Initializes an employee and associates them with a department
     */
    ...
    /** 
     * @return current static employee ID counter 
     */
    public static int getStaticEmployeeId() {
        return staticEmployeeId;
    }
    /** 
     * @param staticEmployeeId sets the static employee ID counter 
     */
